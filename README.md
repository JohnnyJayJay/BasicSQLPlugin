...
We will start with some general prerequisites and make some preparations.\
After this we will look at the `DataSource` class and establish our first connection to our database.\
Before teaching you how to read and write data from and to the database, we will need to introduce some best practices. This will make
it easier for you to work with your database.\
Moving on, we can finally learn about the different ways databases can be updated, using a simple coins
plugin as an illustrating example.

After reading this guide you will have basic knowledge how to develop an application with a stable and good database
implementation.

This guide won't be the end of your journey, however; databases are a really large topic, thus we can't cover everything here.
You might think this is much, but we are just scraping the surface.
